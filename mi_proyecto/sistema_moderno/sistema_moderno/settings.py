"""
Django settings for sistema_moderno project.
...
SECRET_KEY = 'django-insecure-58s3z@bhqdeuu%*3yu&*gm_5cdt%zsv17^k=0bnfg5e@7c(9_n'
...
WSGI_APPLICATION = 'sistema_moderno.wsgi.application'
